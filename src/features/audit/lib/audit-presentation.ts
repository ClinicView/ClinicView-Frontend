...
export const AUDIT_ACTION_OPTIONS = [
  ...
  "PATIENT_VIEWED",
  "PATIENT_UPDATED",
  "CLINICAL_SUMMARY_VIEWED",
  "CLINICAL_SUMMARY_UPDATED",
  "PATIENT_DEACTIVATED",
  "PATIENT_ACTIVATED",
  "CLINICAL_HISTORY_EXPORTED",
  "CLINICAL_HISTORY_SEARCHED",
  "CLINICAL_RECORD_CREATED",
  "CLINICAL_RECORD_PUBLISHED",
  "CLINICAL_RECORD_CONFIRMED",
  "EPISODE_CREATED", "EPISODE_UPDATED", "EPISODE_TRANSITIONED", "EPISODE_RECORD_ASSIGNED",
  "CATALOG_CREATED", "CATALOG_UPDATED",
  ...
  "DOCUMENT_REVIEW_RELEASED",
  "DOCUMENT_REVIEW_PRIORITY_CHANGED",
  "DASHBOARD_VIEWED",
  "AUDIT_EVENTS_VIEWED",
] as const;
...
const ACTION_LABELS: Record<string, string> = {
  ...
  CLINICAL_SUMMARY_VIEWED: "Información longitudinal consultada",
  CLINICAL_SUMMARY_UPDATED: "Información longitudinal revisada",
  ...
  CLINICAL_HISTORY_SEARCHED: "Búsqueda en historia clínica",
  CLINICAL_RECORD_CREATED: "Registro clínico creado",
  CLINICAL_RECORD_PUBLISHED: "Atención publicada desde un documento",
  CLINICAL_RECORD_CONFIRMED: "Versión clínica confirmada",
  EPISODE_CREATED: "Episodio creado",
  EPISODE_UPDATED: "Episodio editado",
  EPISODE_TRANSITIONED: "Estado del episodio cambiado",
  EPISODE_RECORD_ASSIGNED: "Agrupación de una atención cambiada",
  CATALOG_CREATED: "Opción de catálogo creada",
  CATALOG_UPDATED: "Opción de catálogo modificada",
  ...
  DOCUMENT_METADATA_UPDATED: "Procedencia del documento corregida",
  ...
  USER_PASSWORD_CHANGED: "Contraseña propia actualizada",
  ROLE_CREATED: "Rol creado",
  ROLE_UPDATED: "Rol actualizado",
  ROLE_PERMISSIONS_UPDATED: "Permisos de rol actualizados",
  ROLE_DELETED: "Rol eliminado",
  GLOBAL_SEARCH_PERFORMED: "Búsqueda global realizada",
  DOCUMENT_REVIEW_CLAIMED: "Revisión documental tomada",
  DOCUMENT_REVIEW_ASSIGNED: "Revisión documental asignada",
  DOCUMENT_REVIEW_RELEASED: "Revisión documental liberada",
  DOCUMENT_REVIEW_PRIORITY_CHANGED: "Prioridad de revisión actualizada",
